...
export default {
  ...
  methods: {
    toEditMenu(id) {
      this.$router.push(`/enterpriseArticle/components/editMenu/${id}`)
    },
    toAddMenu() {
      this.$router.push(`/enterpriseArticle/components/addMenu`)
    },
    toEditArticle(id) {
      console.log(id)
      this.$router.push(`/enterpriseArticle/components/editArticle/${id}`)
    },
    toAddArticle() {
      console.log(this.menuId)
      this.$router.push(
        `/enterpriseArticle/components/addArticle/${this.menuId}`
      )
    },
    indexMethod(index) {
      return index + 1
